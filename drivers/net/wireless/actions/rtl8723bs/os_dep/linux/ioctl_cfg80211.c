			       ...
			       )
{
	...
	if (params->mac[0] == 0xff && params->mac[1] == 0xff &&
	    params->mac[2] == 0xff && params->mac[3] == 0xff &&
	    params->mac[4] == 0xff && params->mac[5] == 0xff) 
	{
		return -EINVAL;	
	}
	...
	while ((rtw_end_of_queue_search(phead, plist)) == _FALSE)	
	{
		...
		if(_rtw_memcmp((u8 *)(params->mac), psta->hwaddr, ETH_ALEN))		
		{
