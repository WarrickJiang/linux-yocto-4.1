...
_func_enter_;
	...
	DBG_871X_LEVEL(_drv_notice_, "set bssid:%pM\n", bssid);
...
_func_enter_;
	...
	DBG_871X_LEVEL(_drv_notice_, "set ssid [%s] fw_state=0x%08x\n",
...
_func_enter_;
	...
	DBG_871X_LEVEL(_drv_notice_, FUNC_ADPT_FMT"  fw_state=0x%08x\n",
...
int rtw_set_band(_adapter *adapter, u8 band)
{
	...
	DBG_871X_LEVEL(_drv_notice_, FUNC_ADPT_FMT" band:%d fail\n", FUNC_ADPT_ARG(adapter), band);
	return _FAIL;
}
