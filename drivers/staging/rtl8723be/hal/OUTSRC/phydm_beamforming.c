...
)
{
	...
	{
		//-@ Modified by David
		SoundPeriod_SW = 20;	//32*20?
		SoundPeriod_FW = 20;	// From  H2C cmd, unit = 10ms
	...
	)
{
	...
	pBeamOidInfo->SoundOidMode = Mode;
...
RT_STATUS Beamforming_GetReportFrame(	IN	PADAPTER		Adapter, 	IN	PRT_RFD			pRfd, IN	POCTET_STRING	pPduOS){return RT_STATUS_SUCCESS;}
VOID Beamforming_GetNDPAFrame(	IN	PADAPTER		Adapter, 	IN	OCTET_STRING	PduOS){}
